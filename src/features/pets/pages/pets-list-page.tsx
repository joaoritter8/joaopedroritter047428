      ...
      <Card>
        <CardContent className="flex flex-col gap-3 p-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="text-sm text-zinc-600">Listagem paginada de pets (10 por página) com busca por nome.</p>
          </div>
          ...
          <div className="w-full sm:max-w-sm">
            ...
            <div className="relative">
              ...
              <Input className="pl-9" value={draft} onChange={(e) => setDraft(e.target.value)} placeholder="ex: Mel" />
            </div>
          </div>
        </CardContent>
      </Card>
