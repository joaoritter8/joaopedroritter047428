...
const schema = z.object({
  nome: z.string().min(1, 'Informe o nome').max(100, 'Máximo 100 caracteres'),
        ...
        <CardHeader className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="text-sm text-zinc-600">
              Campos: nome, raça, idade. Upload opcional de foto.
            </p>
          </div>
        ...
        <CardContent className="p-6">
          <form className="grid gap-4" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div>
              ...
              {errors.raca ? (
                <p className="mt-1 text-xs text-red-600">{errors.raca.message}</p>
              ) : null}
            </div>
            ...
            <div>
              ...
              {errors.idade ? (
                <p className="mt-1 text-xs text-red-600">{errors.idade.message as string}</p>
              ) : null}
            </div>
